...
# ⚙Tech Stack:
[![SkillIcons](https://skillicons.dev/icons?i=js,ts,html,css,nodejs,react,next,nuxt,tailwind,bootstrap,java,jquery,php,mysql,mongodb,git,figma,markdown,nginx,docker)](https://motidev.com)<br/>
