...
# ⚙Tech Stack:
[![SkillIcons](https://skillicons.dev/icons?i=js,ts,html,css,nodejs,react,next,nuxt,tailwind,bootstrap,java,jquery,php.laravel-dark,mysql,mongodb,sqlite,git,figma,markdown,nginx,docker,c#)](https://motidev.com)<br/>
