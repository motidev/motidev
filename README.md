...
# ⚙Tech Stack:
[![SkillIcons](https://skillicons.dev/icons?i=js,ts,html,css,nodejs,react,next,nuxt,tailwind,bootstrap,java,jquery,php,mysql,mongodb,dataverse,sqlite,git,figma,markdown,nginx,docker,c#)](https://motidev.com)<br/>
